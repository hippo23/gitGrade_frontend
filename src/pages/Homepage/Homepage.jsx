...
import SidebarNavlink from "./reused_components/SidebarNavlink";
      ...
      <div className="font-semibold bg-black rounded-r-lg h-full w-full flex flex-col py-[1rem] px-[2rem] border-r-[1px] border-slate-150">
        ...
        <div className="bg-inherit h-fit text-white flex flex-col mb-[2rem]">
          ...
          <div className="ml-[0.25rem] flex flex-col">
            <SidebarNavlink destination="dashpanel" label="Homepage" svg={
              <svg
            ...
            <SidebarNavlink destination="/student/curriculum_checklist" label="Curriculum Checklist" svg={
              <svg
                className="mr-[1rem] w-4 h-4 fill-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <SidebarNavlink destination="/student/gradespanel" label="Grades" svg={
              <svg
            ...
            <SidebarNavlink destination="/faculty/teachercoursepanel" label="Courses" svg={
              <svg
                className="mr-[1rem] w-4 h-4 stroke-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <SidebarNavlink destination="/admin/organizationcoursespanel" label="School Courses" svg={
              <svg
                className="mr-[1rem] w-4 h-4 stroke-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          ...
          <div className="flex flex-col ml-[0.25rem]">
            <SidebarNavlink destination="/admin/accounts" label="Accounts" svg={
              <svg
                className="mr-[1rem] w-4 h-4 stroke-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <SidebarNavlink destination="/admin/hrpanel" label="Employees" svg={
              <svg
