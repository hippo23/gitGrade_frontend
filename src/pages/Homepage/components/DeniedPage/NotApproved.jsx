    ...
    <div className="h-full w-full bg-gray-100 flex items-center justify-center">
      <div className="h-[25rem] w-[30rem] bg-white flex flex-col items-center justify-center rounded-md shadow-lg">
        ...
        <div className="p-[2rem] flex flex-col">
            <h1 className="font-bold text-orange-700 self-center mb-[1rem]">ERROR</h1>
            <p>Your account is currently pending for approval. If there has been any error, please contact the administration at <span className="text-blue-500 underline">aamagleo@gmail.com</span>.</p>
        </div>
      </div>
    </div>
  );
