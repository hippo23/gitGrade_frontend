...
const DashPanel = (props) => {
  return (
    <div className="h-full w-full bg-inherit grid rounded-xl grid-rows-[400px_1fr] place-items-center gap-[2rem]">
      <div className="w-[90%] h-full grid grid-rows-[0.6fr_1fr]">
        <div className="mb-[2rem] flex flex-row items-center border-b-[1px] border-gray-200">
          <div>
