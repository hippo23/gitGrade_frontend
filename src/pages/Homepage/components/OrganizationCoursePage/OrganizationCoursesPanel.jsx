...
const OrganizationCoursesPanel = (props) => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="h-full w-full bg-white overflow-hidden grid grid-rows-[0.1fr_0.07fr_1fr] px-[5rem] py-[2rem]">
        {showAddForm ? (
          <CourseForm
        ...
        <div className="border-t-[1px] border-slate-150 px-[1rem] flex items-center">
          <button
            ...
            className="font-semibold border-[1px] border-gray-500 text-black flex gap-2 bg-transparent h-fit px-[1rem] py-[0.4rem] min-w-[4rem] text-[0.75rem] ml-auto items-center justify-center w-fit rounded-md"
          >
            <span>
              <svg
                className="h-4 w-4"
