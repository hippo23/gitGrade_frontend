...
const CourseForm = ({ hideAddFormListener, setCourses, onSubmit }) => {
  ...
  return (
    <form
      ...
      className="z-50 flex flex-col bg-white border-[0.1rem] shadow-md border-gray-200 rounded-md min-h-[25rem] w-[30rem] fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] pt-[2rem] pb-[3rem] px-[2rem]"
    >
      <button
