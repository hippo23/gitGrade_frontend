    ...
    return (
        <div className="h-full w-full grid grid-rows-[auto_1fr]">
            ...
            <div className="w-fit h-[5rem] ml-auto">
                <button type="button" class="border-[1px] border-gray-200 text-black bg-white hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Year Level</button>
                ...
                <div className="p-[2rem] h-[100%] w-full overflow-x-auto flex items-center justify-center">
                    <table className="h-full overflow-y-scroll max-h-full w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
